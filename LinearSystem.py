...
def MatEqnConverter_Collocation_InnerNodes(element_list):
...
def MatEqnConverter_Collocation_BC_old(alpha, beta, element_list, C, d, ind_1st):
...
def MatEqnConverter_Collocation_BC(element_list, C, d, ind_1st):
    # Constructing equations for boundary nodes
    # The BC equation is alpha * u + beta * pu_pn = gamma
    # RHS: the boundary nodes of RHS include values of gamma
    # element_list: list of all elements
